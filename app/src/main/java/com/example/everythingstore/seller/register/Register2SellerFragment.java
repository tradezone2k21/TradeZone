 ...
 * Use the {@link Register2SellerFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Register2SellerFragment extends Fragment {
    ...
    public Register2SellerFragment() {
     ...
     * @return A new instance of fragment Register2SellerFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Register2SellerFragment newInstance(String param1, String param2) {
        Register2SellerFragment fragment = new Register2SellerFragment();
    ...
    public void onResume() {
        super.onResume();
//        Toast.makeText(getActivity(), Prefs.getString("sellerNameRegister","Name Error"), Toast.LENGTH_SHORT).show();
//        Toast.makeText(getActivity(), Prefs.getString("sellerPhoneRegister","Phone Error"), Toast.LENGTH_SHORT).show();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_register2_seller, container, false);
        addressText=view.findViewById(R.id.add_sell_register);
        cityText=view.findViewById(R.id.city_sell_register);
        pincodeText=view.findViewById(R.id.pincode_sell_register);
        stateText=view.findViewById(R.id.state_sell_register);
        signUpButton=view.findViewById(R.id.signup_sell_register);
        error_box=view.findViewById(R.id.error_box_sell_register);
        ...
        signUpButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                name=Prefs.getString("sellerNameRegister","ERROR Name").trim();
                phone=Prefs.getString("sellerPhoneRegister","ERROR Phone").trim();

                SellerSignUpModel sellerSignUpModel=new SellerSignUpModel(name,phone,address,city,pincode,state);
//                Log.d("testFragmentOnclick", "onClick: "+name+" "+phone+" "+address+" "+city+" "+pincode+" "+state);
                ...
                if(areDetailsValid()  && !userExisting()){
                    ...
                    reference.child(phone).setValue(sellerSignUpModel);
